...
protocol-generate: ## 从权威 schema 生成 Go、TypeScript 与业务 schema
...
protocol-sync-scriptcat: protocol-generate ## 更新相邻 ScriptCat 仓库的生成产物
	...
	cp internal/pkg/protocol/generated/schema.generated.ts $(SCRIPTCAT_DIR)/src/app/service/service_worker/external_access/generated/schema.generated.ts
	pnpm --dir $(SCRIPTCAT_DIR) exec prettier --write \
		...
		$(SCRIPTCAT_DIR)/src/app/service/service_worker/external_access/generated/schema.generated.ts
